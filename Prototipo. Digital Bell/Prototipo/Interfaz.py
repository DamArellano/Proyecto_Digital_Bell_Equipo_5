...
def crear_interfaz(logica_programa):
    ...
    def Menu():
        ...
        Texto = tk.Label(menu_frame, text="BIENVENID@ A DIGITAL BELL", font=("Myanmar Khyay", 20,"bold"), bg="white")
        Texto.pack(side=tk.TOP, pady=20)

        Registra = tk.Button(menu_frame, text="Crear cuenta", command=Registro, font=("Myanmar Sans Pro", 15), bg="green",fg="white")
        Registra.pack(side=tk.TOP, pady=(80,10), padx=10)
    ...
    def Horario_Habitante():
        ...
        Regresar = tk.Button(ventana, text = "Volver al menu", command = Menu_Habitante, font=("Myanmar Sans Pro", 10),bg="green",fg="white")
        Regresar.pack(side = tk.TOP, pady = 10)

        if not Horario:
            Texto = tk.Label(ventana, text = "No hay horarios disponibles de momento", font = ("Myanmar Sans Pro",10),bg="green",fg="white")
    ...
    def Menu_Empleado():
        ...
        Cerrar = tk.Button(ventana, text = "Cerrar Sesión", command = Cerrar_Sesion,bg="red",fg="white")
        Cerrar.pack(pady = 10)
    ...
    def Menu_Admin():
        ...
        Texto.pack(side = tk.TOP, pady = 10)
        Horario = tk.Button(ventana, text = "Horarios", command = Ingresar_Horarios, font = ("Myanmar Sans Pro", 10),bg="green",fg="white")
        Horario.pack(side = tk.TOP, pady = 10)
        Actualizar = tk.Button(ventana, text = "Actualizar ubicación", command = Actualizar_Ubicacion, font = ("Myanmar Sans Pro", 10),bg="green",fg="white")
        Actualizar.pack(side = tk.TOP, pady = 10)
        Queja = tk.Button(ventana, text = "Quejas y sugerencias", command = Quejas, font = ("Myanmar Sans Pro", 10),bg="green",fg="white")
    ...
    def Ingresar_Horarios():
        ...
        Texto1 = tk.Label(ventana, text = "Número de Empleado a asignar",bg="green",fg="white")
        Texto1.pack(side = tk.TOP, pady = 5)
        Num = tk.Entry(ventana)
        Num.pack(side = tk.TOP, pady = 5)
        Texto5 = tk.Label(ventana, text = "¿Por donde va a empezar el recorrido?",bg="green",fg="white")
        Texto5.pack(side = tk.TOP, pady = 5)
        Partida = tk.Entry(ventana)
        Partida.pack(side = tk.TOP, pady = 5)
        Texto2 = tk.Label(ventana, text = "Ingrese la segunda dirección",bg="green",fg="white")
        Texto2.pack(side = tk.TOP, pady = 5)
        Calle2 = tk.Entry(ventana)
        Calle2.pack(side = tk.TOP, pady = 5)
        Texto3 = tk.Label(ventana, text = "Ingrese la tercera dirección",bg="green",fg="white")
        Texto3.pack(side = tk.TOP, pady = 5)
        Calle3 = tk.Entry(ventana)
        Calle3.pack(side = tk.TOP, pady = 5)
        Texto4 = tk.Label(ventana, text = "Ingrese la cuarta dirección",bg="green",fg="white")
        Texto4.pack(side = tk.TOP, pady = 5)
        Calle4 = tk.Entry(ventana)
        Calle4.pack(side = tk.TOP, pady = 5)

        Asignar = tk.Button(ventana, text = "Asignar horarios", command = Asignar_Horarios,bg="green",fg="white")
    ...
    def Actualizar_Ubicacion():
        ...
        Texto = tk.Label(ventana, text = "Ingrese el número de empleado",bg="green",fg="white")
        Texto.pack(side = tk.TOP, pady = 10)
        Num = tk.Entry(ventana)
        Num.pack(side = tk.TOP, pady = 10)
        Texto1 = tk.Label(ventana, text = "Ingrese su ubicación actual",bg="green",fg="white")
    ...
    def Quejas():
        ...
        Regresar.pack(side = tk.TOP, pady = 10)
        if not Queja:
            Texto = tk.Label(ventana, text = "No hay quejas de momento", font = ("Myanmar Sans Pro",10),bg="green",fg="white")
            Texto.pack(side = tk.TOP,pady = 10)
        else:
            for quejas in Queja:
